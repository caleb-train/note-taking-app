  ...
  || (
    <div className="w-4/5 md:w-3/5 flex flex-col mx-auto">
      ...
      <section className="h-4/5">
        <textarea onInput={auto_grow} onChange={updateNote} name="body" className={`w-full md:p-8 p-6 outline-none min-h-3/5 text-sm overflow-hidden font-montserrat ${editNote.color || 'wht'}`}></textarea>
      </section>
    </div>
  )
}
