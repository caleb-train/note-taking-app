    ...
    : (editNote && (
      <div className="w-4/5 md:w-3/5 h-full flex flex-col mx-auto">
        ...
        <section className="h-4/5">
          <textarea onInput={auto_grow} onChange={updateNote} name="body" value={editNote.body} className={`w-full md:p-8 p-6 rumple outline-none min-h-4/5 text-sm font-montserrat ${editNote.color || 'wht'}`}></textarea>
